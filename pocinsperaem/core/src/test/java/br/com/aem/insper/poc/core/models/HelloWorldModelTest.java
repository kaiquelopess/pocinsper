 ...
 */
package br.com.aem.insper.poc.core.models;
...
import br.com.aem.insper.poc.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "pocinsperaem/components/helloworld");
